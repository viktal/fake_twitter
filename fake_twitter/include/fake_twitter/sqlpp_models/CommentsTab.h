...
struct comment_for {
    struct _alias_t {
        ...
        struct _member_t {
            T comment_for;
            T& operator()() { return comment_for; }
            const T& operator()() const { return comment_for; }
        };
    };
    using _traits = sqlpp::make_traits<sqlpp::integer>;
};
...
struct TabComments
    : sqlpp::table_t<TabComments, TabComments_::id, TabComments_::body,
                     TabComments_::author, TabComments_::comment_for,
                     TabComments_::create_date, TabComments_::rating> {
    struct _alias_t {
