...
struct followers_count {
    struct _alias_t {
        ...
        struct _member_t {
            T followers_count;
            T& operator()() { return followers_count; }
            const T& operator()() const { return followers_count; }
        };
    };
    using _traits = sqlpp::make_traits<sqlpp::integer>;
};
struct friends_count {
    struct _alias_t {
        ...
        struct _member_t {
            T friends_count;
            T& operator()() { return friends_count; }
            const T& operator()() const { return friends_count; }
        };
    };
    using _traits = sqlpp::make_traits<sqlpp::integer>;
};
